...
public void test1() throws Exception {
    ...
    List<String> children = zooKeeper.getChildren("/xxx", new Watcher() {
        @Override
        public void process(WatchedEvent watchedEvent) {
            try {
                List<String> children = children = zooKeeper.getChildren("/xxx", this);
...
```javascript
[zk: localhost:2181(CONNECTED) 23] create /xxx/dog2
```
...
```javascript
[zk: localhost:2181(CONNECTED) 24] create /xxx/dog3
```
