...
3. 测试项目
   ...
   com.xxx.dubbo.api 公共类模块

   com.xxx.dubbo.userservice 用户服务模块，作为provider

   com.xxx.dubbo.orderservice 订单服务模块，作为consumer
...
<beans xmlns="http://www.springframework.org/schema/beans"
       ...
       <!-- 4.暴露服务 -->
       <bean id="userServiceImpl" class="com.xxx.dubbo.userservice.impl.UserServiceImpl" />
       <dubbo:service interface="com.xxx.dubbo.api.service.UserService" ref="userServiceImpl" />
</beans>
```
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <!-- 3.引用服务 -->
    <dubbo:reference interface="com.xxx.dubbo.api.service.UserService" />
</beans>
```
