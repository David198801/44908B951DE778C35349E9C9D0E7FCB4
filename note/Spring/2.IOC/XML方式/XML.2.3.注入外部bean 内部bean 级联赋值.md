...
```javascript
<bean id="userDaoImpl" class="com.xxx.spring.dao.UserDaoImpl"/>
<bean id="userServiceImpl" class="com.xxx.spring.service.UserServiceImpl">
...
<bean id="user" class="com.xxx.spring.bean.User">
    ...
    <property name="group">
        <bean id="group1" class="com.xxx.spring.bean.Group">
            <property name="id" value="1"/>
